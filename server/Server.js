...
const singleBlog = require("./Blog/SingleBlog")
...
app.get("/singleBlog/:id",VerifyToken.verifyToken,singleBlog.singleBlog)
app.get("/Profile/:id",VerifyToken.verifyToken,profile.Profile)
